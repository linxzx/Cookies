...
<!--注册¡-->
			...
			<form action="#" method="post">
				...
				<input type="radio" Name="usersex" checked="checked" required=""><font color="white">男</font>
				<input type="radio" Name="usersex" checked="checked" required=""><font color="white">女</font>
